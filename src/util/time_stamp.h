...
public:
  ...
  explicit TimeStamp(const qg_int64_t unixTimeStamp)
      : unix_time_stamp_(unixTimeStamp){}
...
inline qg_bool operator<(TimeStamp lhs, TimeStamp rhs) {
...
inline TimeStamp addTime(TimeStamp timeStamp, qg_double seconds) {
  auto delta =
      static_cast<qg_int64_t>(seconds * TimeStamp::kMicroSecondsPerSecond);
